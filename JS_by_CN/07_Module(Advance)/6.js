...
// when Call to outer fun is completed , The Variables associated with outer fun NOT be there anymore but still do exist ( bcoz of the concept of Closure )
// we are talking about the concept of Closure with respect of inner function 
// Ideally inner fun should not have variable 'j' anymore,  but Bcoz of the concept of closure it will still exist in memory.
...
But in JS -  It  preserves in the memory,  Not get deleted actually. ( Bcoz of the concept of Closure )
*/
